...
## Change the unit of analysis from the complete dataset to individual groups
...
```
# This is the 2nd set of code which generated an error, but both codes were mirrored exactly to the text examples. 
