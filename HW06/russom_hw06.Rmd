---
title: "HW06 Part 1: Data Importing and Wrangling 1"
...
read_csv("a,b,c\n1,2\n1,2,3,4") - only 3 column names are provided so data is lost

read_csv("a,b\n\"1")- Quotation marks are not closed

read_csv("a,b\n1,2\na,b") - ?

read_csv("a;b\n1;3") - read_csv() works with commas, doesn't recognize semicolons
...
Between is a shortcut for less than & equal to and greater than and equal to
...
Flights that traveled the longest
```{r}
...
The variables you repeat will be ommitted
